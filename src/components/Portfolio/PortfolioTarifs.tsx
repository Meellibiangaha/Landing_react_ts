...
function PrevTarifBtn() {
    return (
        <button className="prev__tarif__button" onClick={() => console.log(1)}>
...
function NextTarifBtn () {
    return (
        <button className="next__tarif__button" onClick={() => console.log(2)}>
                    ...
                    <div className="portfolio__tarif__silder__lenta">
                        {tarifCardArr.map((tarifCard, index) =>
                            <TarifSingle
                                ...
                                time = {tarifCard.time}
                                className={(index == tarifCardArr.length / 2)? 'portfolio__tarif__single__active' : ''}
